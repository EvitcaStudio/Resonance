...
class ESoundManagerSingleton {
	 ...
	 */
	createSound(pSoundPath, pVolume, pStartTime, pEndTime, pSave, pPlayUnfocused, pPlaybackRate, pLoop, pCallbackObject) {
...
*/
	 ...
	 * @returns { Sound } - A sound object that has vast API on controlling it
	 */
	constructor(pSoundPath, pVolume, pStartTime, pEndTime, pSave, pPlayUnfocused, pPlaybackRate, pLoop, pCallbackObject) {
		this.soundPath = null;
		this.startTime = null;
		this.endTime = null;
		this.save = null;
	 ...
	 * @returns { Sound } - A sound object that has vast API on controlling it
	 */
	build(pSoundPath, pVolume=100, pStartTime=0, pEndTime=0, pSave=false, pPlayUnfocused=false, pPlaybackRate=1, pLoop=false, pCallbackObject) {
