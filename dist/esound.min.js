...
var ESoundManagerSingleton = /*#__PURE__*/function () {
  ...
  function ESoundManagerSingleton() {
    ...
    window.addEventListener('focus', function () {
      _this.focused = true;
      if (_this.pausedSounds.length) _this.resumeAllSounds(true);
  ...
  _createClass(ESoundManagerSingleton, [{
    ...
    key: "enableChecker",
    value: function enableChecker(pCheckerFunction) {
    ...
    key: "createSound",
    value: function createSound(pSoundPath, pVolume, pStartTime, pEndTime, pSave, pPlayUnfocused, pPlaybackRate, pLoop) {
...
var Sound = /*#__PURE__*/function () {
  ...
  */
   ...
   * @returns { Sound } - A sound object that has vast API on controlling it
   */
  function Sound(pSoundPath, pVolume, pStartTime, pEndTime, pSave, pPlayUnfocused, pPlaybackRate, pLoop) {
  ...
  _createClass(Sound, [{
    ...
    key: "on",
    value: function on(pEvent, pCallback) {
      if (typeof pCallback === "function") {
        switch (pEvent) {
          ...
          case "resume":
            ...
            break;
          default:
            console.error("The event \"".concat(pEvent, "\" is not supported."));
        }
      } else {
        console.error("The callback for event \"".concat(pEvent, "\" is not a function."));
      }
      return this;
    }
    /**
    ...
    key: "canPlayUnfocused",
    value: function canPlayUnfocused() {
